        ...
        <Document>
            <Page size="A4" style={styles.page}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.subtitle}>Analysis of: {url}</Text>
                    <Text style={styles.subtitle}>
                        Generated on: {new Date(timestamp).toLocaleString('en-US')}
                    </Text>
                    {!isPremium && (
                        <View style={styles.teaserBadge}>
                            <Text style={styles.teaserText}>FREE PRELIMINARY VERSION</Text>
                        </View>
                    )}
                </View>
                ...
                {!isPremium && (
                    <View style={styles.premiumBlock}>
                        ...
                        <Text style={styles.premiumText}>
                            This is just a free sample. To see the full report
                            with all detailed fixes and step-by-step guides:
                        </Text>
                        <Text style={styles.premiumCTA}>
                            Login at roastthis.site
                        </Text>
                        <Text style={{ fontSize: 9, color: '#666', marginTop: 5, textAlign: 'center' }}>
                            (Your data is already saved in our platform)
                        </Text>
                    </View>
                )}
                ...
                <View style={styles.footer}>
                    <Text style={styles.footerText}>
                        Generated by Roasty | roastthis.site | powered BY Roast
                    </Text>
                </View>
            </Page>
        </Document>
