...
async function test() {
    console.log('Sending test email to negraodenio@gmail.com using the official domain...');
    try {
        const { data, error } = await resend.emails.send({
            from: 'Roasty <noreply@roastthis.site>', // Using verified domain
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #0a0a0a; border: 1px solid #222; border-radius: 16px; overflow: hidden; margin-top: 20px; margin-bottom: 20px;">
        ...
        <div style="padding: 40px 30px; text-align: center;">
            ...
            <p style="font-size: 16px; line-height: 1.6; color: #aaa; margin-bottom: 35px;">
                ...
                The full audit for <strong>https://roastthis.site</strong> is now unlocked.
            </p>
